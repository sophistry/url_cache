<?php
App::import('Lib', 'UrlCache.url_cache_app_helper');
...
/**
 * dont extend app helper to avoid app specific overrides and errors
 */
class HtmlHelper extends UrlCacheAppHelper {
